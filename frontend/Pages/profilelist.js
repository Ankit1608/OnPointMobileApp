        ...
        <ScrollView>
          ...
          <View style={styles.lists}>
            <Pressable
              onPress={() => {
                navigation.navigate('EditProfile', {
                  userid: userid_data.me,
                  nameparam: userdetails.user.name,
                  phonenumberparam: userdetails.user.phone,
                  emailparam: userdetails.user.email,
                });
              }}>
              <View style={styles.listitem}>
                <FaIcon name={'pencil-alt'} size={17} color="black" />
            ...
            <TouchableOpacity
              ...
              <View style={styles.listitem}>
                <FaIcon name={'bell'} size={17} color="black" />
                <Text style={styles.listtext}>Notifications</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Aboutus')}>
              <View style={styles.listitem}>
                <FaIcon name={'user'} size={17} color="black" />
            ...
            <TouchableOpacity
              ...
              <View style={styles.listitem}>
                <FaIcon name={'comment'} size={17} color="black" />
                <Text style={styles.listtext}>Send Feedback</Text>
              </View>
            </TouchableOpacity>
            <View style={styles.listitem}>
              <FaIcon name={'star'} size={17} color="black" />
